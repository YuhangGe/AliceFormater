...
#define LIST_LENGTH 80
typedef hash_map<const char*,int>::value_type TokenTag;
...
const  hash_map<const char *,int> JSLexer::tag_list(init_list,init_list+LIST_LENGTH);
